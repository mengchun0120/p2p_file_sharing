...
set tracefd [open "../trace/test2.tr" w]
set recfd [open "../trace/test2.rec" w]
...
$ns_ at 3.0 "$agent_(2) join-session $val(fid) $val(flen) $val(dlen) 0"
$ns_ at 3.0 "$agent_(3) join-session $val(fid) $val(flen) $val(dlen) 0"
$ns_ at 3.0 "$agent_(4) join-session $val(fid) $val(flen) $val(dlen) 0"
